...
![DefWeb Homepage](<img src="../assets/img/DefWeb/Figure_scenario_new.png" width="200" height="150" alt="Image Description">)
{% include gallery images=images caption="Threat model for the attacker and the defense mechanisms in offline and online phases." cols=4 %}
...
## Installation
* Download the [DefWeb repo]((https://github.com/hunie-son/DefWeb.git))
* Read `README.md` file.
